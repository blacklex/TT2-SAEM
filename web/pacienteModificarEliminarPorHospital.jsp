<%-- 
    Document   : pacienteModificarEliminarPorHospital
    Created on : 13/06/2015, 11:14:11 AM
    Author     : sergio
--%>
...
<section class="content">
    <div class="box box-primary">
            ...
            <form class="sidebar-form" method="get" action="">
                <div class="input-group">
                    ...
                    <span class="input-group-btn">
                        <button id="search-btn" class="btn btn-flat" name="search" type="button" onclick="buscarPacientePorHospitalFiltroUsuario();">
        ...
        <div id="gridPacientes" class="box-body">
           <s:url var="remoteurl" action="ajaxLlenarListaPacientesPorPaciente"/>
...
<script src="js/funcionesHospital/funcionesEliminarEditarPacientePorHospital.js" type="text/javascript"></script>
