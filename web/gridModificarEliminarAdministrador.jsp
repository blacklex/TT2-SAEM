...
<section class="content">
    <div class="box box-primary">
            ...
            <sjg:grid
                ...
                navigatorExtraButtons="{
                                        ...
                                        editarAcceso : {
                                                    title : 'Editar Acceso',
                                                    icon: 'ui-icon-key', 
                                                    onclick: function(){ editarAccesoAdministrador(); }
                                                 },
                                        editarDatos : {
                                                    title : 'Editar Datos Personales',
                                                    icon: 'ui-icon-person', 
                                                    onclick: function(){ editarDatosPersonalesAdministrador(); }
                                                 },
                                        editarDireccion : {
                                        ...
                                        eliminar : { 
                                                    ...
                                                    icon: 'ui-icon-trash',
                                                    onclick: function(){ eliminarAdministrador(); }
                                                   }
                                       }"
                autowidth="true">
        ...
        <s:form enctype="multipart/form-data" name="formEditarDatosPersonalesAdministrador" action="editarDatosPersonalesAdministrador" method="post" role="form">
    ...
    <s:form enctype="multipart/form-data" name="formNuevoAdministrador" action="editarAdminPorFiltro"  method="post" role="form">
        <div id="datosAdministradorPorFiltro" class="box box-primary" style='display:none;'>
            ...
            <div class="box-body">
                ...
                <div id="divImagenAdministrador" class="form-group">
                    <label for="imagen">Imagen</label>
                    <input multiple=false data-preview-file-type="any" name="imagen" id="imagenUpload" class="file" placeholder="Imagen" type="file">
                </div>
            ...
            <div class="box-body">
                ...
                <div class="box-footer">
                    ...
                    <button type="button" class="btn btn-danger btn-sm margin" onclick="eliminarAdministradorPorFiltro();" id="eliminar" style='display:none;'>Eliminar</button>
...
<script src="js/funcionesAdministrador/funcionesEliminarEditarAdministrador.js" type="text/javascript"></script>
