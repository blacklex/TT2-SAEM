    ...
    <div class="box box-primary">
            ...
            <form class="sidebar-form" method="get" action="">
                <div class="input-group">
                    ...
                    <span class="input-group-btn">
                        <button id="search-btn" class="btn btn-flat" name="search" type="button" onclick="consultPacientePorFiltroUsuario();">
        ...
        <div id="datosAccesoPaciente" class="box-body" style='display:none;'>
            ...
            <div id="divClaveUsuario" class="form-group">
                ...
                <input kl_virtual_keyboard_secure_input="on" class="form-control" id="clave" name="clave" placeholder="Clave de Acceso" type="password" autofocus="true" readonly="true"/>
            </div>
